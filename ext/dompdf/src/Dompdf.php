...
class Dompdf
{
    ...
    */
    ...
    public function loadHtml($str, $encoding = 'UTF-8')
    {
        ...
        if ($this->options->isHtml5ParserEnabled() && class_exists("Tokenizer")) {
            ...
            $quirksmode = ($tokenizer->getTree()->getQuirksMode() > TreeBuilder::NO_QUIRKS);
        } else {
     ...
     * @param string $orientation 'portrait' or 'landscape'  (竖 | 横)
     * @return $this
     */
